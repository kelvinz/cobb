...
- When the underlying change alters anything a README describes (setup, commands, workflows, structure, scope), check `README.md` in the repo root and any touched directory and update stale sections in the same phase. In read-only `review`, propose README updates instead of editing.
